...
class LLMParser:
    def __init__(self, api_key):
        if cfg.LLM_MODEL_TYPE == 'gemini':
            ...
            self.llm_embeddings = GoogleGenerativeAIEmbeddings(google_api_key=api_key, model="models/text-embedding-004")
        else:
            self.llm = LoggerChatModel(
                ChatOpenAI(
            ...
            self.llm_embeddings = OpenAIEmbeddings(openai_api_key=api_key)  # Initialize embeddings
