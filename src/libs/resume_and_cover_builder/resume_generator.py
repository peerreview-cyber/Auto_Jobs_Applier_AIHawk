...
from .llm.llm_generate_resume import LLMResumer
from .llm.llm_generate_resume_from_job import LLMResumeJobDescription
from .llm.llm_generate_cover_letter_from_job import LLMCoverLetterJobDescription
...
class ResumeGenerator:
    ...
    def _create_resume(self, gpt_answerer: Any, style_path):
        ...
        # Clean up markdown if LLM included it (strips all ```html and ``` occurrences)
